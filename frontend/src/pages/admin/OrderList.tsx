    ...
    <div className="max-w-7xl mx-auto">
      ...
      <div className="mb-6 flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-gray-600 mt-1">Historial de pedidos de tus clientes</p>
        </div>
      </div>
      ...
      <div className="md:hidden space-y-4">
        {orders.map((order) => (
          <div key={order.id} className="bg-white rounded-xl shadow-md p-5 border border-yellow-100">
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="flex items-center gap-2 text-gray-600">
                ...
                <span className="font-semibold text-yellow-600">{formatCurrencySimple(order.total)}</span>
              </div>
              <div className="flex items-center gap-2 text-gray-600">
