                  ...
                  >
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <button
                        ...
                        className="inline-flex items-center gap-2 px-3 py-2 text-sm font-medium text-white bg-yellow-500 hover:bg-yellow-600 rounded-lg transition"
                      >
                        <FiEye size={16} />
                        Ver detalles
                      </button>
          ...
          {orders.map((order) => (
            ...
            >
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 px-3 py-2 text-sm font-medium text-white bg-yellow-500 hover:bg-yellow-600 rounded-lg transition"
              >
                <FiEye size={16} />
